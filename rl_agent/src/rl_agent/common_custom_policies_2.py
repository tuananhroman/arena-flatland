...
class CustomNetwork(nn.Module):
    ...
    def __init__(
        ...
        self.policy_net = nn.Sequential(
            nn.Linear(HIDDEN_SHAPE_BODY, HIDDEN_SHAPE_POLICY),
            nn.ReLU(),
            nn.Linear(HIDDEN_SHAPE_POLICY, last_layer_dim_pi)
        )

        # Value network
        self.value_net = nn.Sequential(
            nn.Linear(HIDDEN_SHAPE_BODY, HIDDEN_SHAPE_VALUE),
            nn.ReLU(),
            nn.Linear(HIDDEN_SHAPE_VALUE, last_layer_dim_vf)
        )
